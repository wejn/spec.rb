	...
	def process(file)
		...
		file.each do |ln|
			...
			when :img
				...
				@current << img(ln)
			when :table
				cond_switch_state(:table)
				@current << table_line(ln)
			when :comment
			else
...
tr:nth-child(even) { background-color: #eeeee0; }
...
<body>
<div class="main">
<div class="header">Generated by <a href="https://github.com/wejn/spec.rb">spec.rb</a> at: {{{{NOW}}}}</div>
...
<div class="footer">Generated by <a href="https://github.com/wejn/spec.rb">spec.rb</a> at: {{{{NOW}}}}</div>
</div>
</body>
</html>
